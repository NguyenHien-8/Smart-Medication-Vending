# Đặc tả thiết kế Smart_Vending ESP32-S3
...
Xây dựng một firmware Arduino IDE tự chứa cho Smart_Vending, tích hợp Wi-Fi portal, TFT ST7789, hội thoại giọng nói qua Xiaozhi Official Cloud, luật an toàn y khoa cục bộ, danh mục/tồn kho và điều khiển 16 relay qua CD74HC4067.
...
- `Smart_Vending.ino` chỉ tạo app, gọi `begin()` và `process()`.
