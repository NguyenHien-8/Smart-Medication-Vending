...
#include "vending/transport_health_gate.h"
...
#define MAIN_EVENT_TRANSPORT_DISCONNECTED (1 << 14)
...
public:
    ...
    // A transport loss invalidates pending dispensing even when Wi-Fi stays up.
    bool IsTransportOperational() const { return transport_health_.IsOperational(); }
...
private:
    ...
    smv::TransportHealthGate transport_health_;
    ...
    void ReportTransportLoss();
    void ScheduleTransportReady(bool require_audio_channel);
